...
export function ChartsContent() {
  ...
  const [activeKarats, setActiveKarats] = useState<string[]>([
    "price21",
    "price24",
  ]);
  ...
  const CustomTooltip = ({
    ...
    return (
      <div
        className="bg-card border border-border rounded-xl p-3 shadow-xl text-sm"
  ...
  const NUMERIC_KEYS = ["price24", "price21", "price18"] as const;
        ...
        <div className="gold-card p-4">
          ...
          <ResponsiveContainer width="100%" height={260}>
            ...
            >
              ...
              {KARATS.filter(({ key }) => activeKarats.includes(key)).map(
                ({ key, color }) => (
                  <Area
                    key={key}
                    type="monotone"
        ...
        <div className="gold-card p-4">
          ...
          <ResponsiveContainer width="100%" height={220}>
            ...
            >
              ...
              <Legend
                formatter={(value) =>
                  KARATS.find((k) => k.key === value)?.label ?? value
                }
                wrapperStyle={{
